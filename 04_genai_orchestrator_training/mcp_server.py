...
mcp = FastMCP(name="SAP", host="0.0.0.0",port=8051)
...
def retriever(question: str):
    """Tool that retrieves and answers a question about SAP Datasphere and SAP Business Data Cloud from SAP HANA Vector database."""
